...
`label` appears in journal records and generated log names. `observe`, `warn` and `diagnostic` add visibility; see [observability](../observability/). [Multi-pass execution](../iteration/) explains environment reuse.
