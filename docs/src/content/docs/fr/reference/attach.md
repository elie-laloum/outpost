...
| `options.terminal`           | `{ readonly input?: import("stream").Readable; readonly output?: import("stream").Writable; readonly error?: import("stream").Writable; } \| undefined` | Optionnel | Flux d’entrée, de sortie et d’erreur pour l’attachement à un terminal interactif réel.                                                                                                               |
