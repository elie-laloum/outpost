...
| `capture`               | `boolean \| undefined \| false`                                                        | Selon la variante | Indique si l’adapter active la capture des transcripts natifs.                                                                                                             |
| `resumable`             | `boolean \| undefined \| false`                                                        | Selon la variante | Indique si l’adapter prend en charge la continuation native des conversations.                                                                                             |
