...
Les [budgets](../../../../guide/workflows/budgets/) et [OpenTelemetry](../../../../guide/advanced/telemetry/) décrivent les limites de consommation et les métriques respectant la confidentialité.

Voir les [politiques de rétention et quotas](../../../../guide/operations/storage-retention/) pour le nettoyage explicite des journaux fermés.
