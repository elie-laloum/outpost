...
Voir [les montages](../../../../guide/environment/providers/containers/) et [les limites de sécurité](../../../../guide/operations/security/).

## Connecter un compte

Suivez la [connexion Claude Code](../../../../guide/agents/connect-claude/) ou la [connexion Codex](../../../../guide/agents/connect-codex/) pour les abonnements, clés API et conteneurs. Déclarer OPENAI_API_KEY ne crée pas à lui seul une connexion Codex ; utilisez le hook documenté.
