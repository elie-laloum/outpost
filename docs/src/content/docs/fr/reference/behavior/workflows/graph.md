...
Poursuivez avec [les politiques d’exécution](../../../../guide/workflows/execution/) ou [les tâches de sandbox](../../../../guide/workflows/sandbox-tasks/).

Consultez les [budgets de consommation](../../../../guide/workflows/budgets/) pour les limites partagées d’admission et de tokens, et la [télémétrie](../../../../guide/advanced/telemetry/) pour les métriques structurées.

Conservez les résultats après un redémarrage avec les [checkpoints de workflow](../../../../guide/advanced/checkpoints/).

Utilisez les [approbations et pauses](../../../../guide/advanced/approvals/) pour arrêter le workflow sur une décision persistante, les [artefacts typés](../../../../guide/advanced/artifacts/) pour échanger des données validées et les [workers distribués](../../../../guide/advanced/distributed/) pour une exécution en file. Les [candidats spéculatifs](../../../../guide/advanced/speculation/) constituent un prototype de recherche séparé sur activation explicite.
