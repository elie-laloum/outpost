...
Utilisez cette recette pour préserver un travail partiel. Préparez l’[installation commune](../../../../guide/cookbook/) et la connexion Claude. Nettoyage et collecte peuvent continuer après le délai de la demande.
...
Conservez les commits de la branche nommée. Inspectez les worktrees avant déplacement ou suppression. Voir la [reprise](../../../../guide/agents/conversations/) et les [informations de récupération](../../../../guide/operations/recovery/).
