...
Cette recette autorise explicitement l’intégration dans la branche hôte après validation. Partez d’une branche attachée et propre avec l’[installation commune](../../../../guide/cookbook/). Adaptez les tests au projet.
...
Ajoutez lint et vérification des types après implémentation. Si le relecteur peut modifier, relancez les tests après revue. Séparez les sandboxes pour le parallèle. Voir la [récupération](../../../../guide/operations/recovery/) après un contrôle échoué.
