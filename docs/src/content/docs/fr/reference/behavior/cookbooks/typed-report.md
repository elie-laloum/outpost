...
Utilisez cette recette lorsqu’un tableau de bord ou une tâche attend des données structurées. Préparez la [connexion Claude](../../../../guide/agents/connect-claude/) et l’[installation commune](../../../../guide/cookbook/).
...
Un tour de réparation peut reprendre avec les erreurs de validation. Si la réparation échoue, une erreur expose les informations de récupération. Gardez une seule passe pour une réponse structurée. Voir les [réponses validées](../../../../guide/agents/responses/).
