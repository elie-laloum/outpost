...
Construisez d’abord [l’image du conteneur](../../../../guide/environment/providers/agent-images/). Omettez `networks: "none"` si la tâche nécessite le réseau, notamment les API de modèles. Configurez l’authentification avec les [guides des agents](../../../../guide/agents/connect-codex/) ; le home reste privé et éphémère. L’image, le moteur et les identifiants explicites restent des entrées de confiance.
