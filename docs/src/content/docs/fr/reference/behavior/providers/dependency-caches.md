...
Utilisez les commandes `podman volume` équivalentes pour Podman. Inspectez et supprimez les volumes individuellement, sans nettoyer les ressources étrangères. Les [images d'agents préconstruites](../../../../guide/environment/providers/agent-images/) réduisent aussi le temps de préparation.

Les volumes de cache sont en dehors des [quotas de stockage du dépôt](../../../../guide/operations/storage-retention/).
