...
Docker/Podman montent les métadonnées Git par défaut ; le [prototype de dépôt isolé](../../../../guide/advanced/repository-isolation/) utilise un checkout privé synchronisé par bundles. [Firecracker](../../../../guide/advanced/firecracker/) est un backend de recherche nécessitant un hôte Linux préparé ; ses tests simulés ne prouvent ni un démarrage réel ni une isolation de production. Les [politiques réseau sortantes](../../../../guide/advanced/egress/) proposent le blocage total des conteneurs et les règles du pare-feu Vercel, avec des limites propres à chaque provider.
