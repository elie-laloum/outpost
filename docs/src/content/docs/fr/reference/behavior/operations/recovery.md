...
Consultez les [contrôles de structure, empreintes et restauration Git](../../../../guide/operations/recovery-verification/).

## Vérifier les empreintes enregistrées du transfert

Les [manifestes SHA-256](../../../../guide/operations/recovery-verification/) sont vérifiés explicitement, séparément de l’applicabilité des patches.
...
Consultez aussi la [rétention et les quotas](../../../../guide/operations/storage-retention/) pour planifier un nettoyage explicite.
