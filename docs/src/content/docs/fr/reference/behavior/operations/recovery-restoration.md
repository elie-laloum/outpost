...
Après [l’inventaire des données de récupération](../../../../guide/operations/recovery/) et [la vérification du transfert conservé](../../../../guide/operations/recovery-verification/), choisissez l’état à reconstruire. La restauration crée un checkout Git indépendant dans un nouveau dossier extérieur au dépôt source, aux métadonnées Git et au transfert. Son dossier parent doit déjà exister. Toute destination existante, même vide ou symbolique, est refusée.
