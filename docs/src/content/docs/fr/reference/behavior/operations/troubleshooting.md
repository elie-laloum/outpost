...
Utilisez [le diagnostic hôte](../../../../guide/operations/doctor/) pour vérifier les prérequis avant d’examiner un échec d’exécution.
...
Pour signaler un problème, fournissez OS, versions de Node/Outpost/provider/agent, code d’erreur expurgé et configuration minimale. Retirez identifiants, prompts privés et sources des logs partagés. Voir [récupération](../../../../guide/operations/recovery/) et [sécurité](../../../../guide/operations/security/).
