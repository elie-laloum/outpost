...
Le manifeste n'avance qu'après une application réussie. Les fichiers supprimés ne peuvent pas réapparaître depuis un manifeste obsolète. Voir [Récupération](../../../../guide/operations/recovery/) pour inspecter et vérifier les tentatives conservées.
