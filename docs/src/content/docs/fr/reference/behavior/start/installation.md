...
Pour Daytona, installez plutôt `@daytona/sdk`. Importez chaque provider via son sous-chemin `@elie-laloum/outpost/providers/*` : les autres SDK cloud restent facultatifs. Consultez le [choix du provider](../../../../guide/environment/providers/overview/).
...
Continuez avec le [démarrage rapide](../../../../guide/start/quickstart/).
