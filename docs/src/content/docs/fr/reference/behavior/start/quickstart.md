...
Ce guide utilise Codex et Docker. Choisissez un dépôt Git contenant un commit. Le workflow sera créé dans un dossier séparé ; consultez aussi [l’installation](../../../../guide/start/installation/).
...
Pour contrôler le cycle de vie, consultez [le dispatch ponctuel](../../../../guide/agents/dispatch/) et [les politiques de branche](../../../../guide/environment/branches/). Pour automatiser plusieurs étapes, poursuivez avec [les workflows](../../../../guide/workflows/graph/).

Pour un accès par compte, suivez [Connecter Codex](../../../../guide/agents/connect-codex/) ou [Connecter Claude](../../../../guide/agents/connect-claude/). La CLI inclut déjà le hook de connexion par clé API Codex dans les scripts générés ; une composition manuelle avec l’API doit le configurer explicitement.
