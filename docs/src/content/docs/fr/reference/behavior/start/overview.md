...
| -------------------------------------------------------- | ------------------------------------------------------------------- |
| Exécuter votre première tâche avec un agent              | [Démarrage rapide](../../../../guide/start/quickstart/)             |
| Comprendre la propriété des ressources et leur fermeture | [Concepts essentiels](../../../../guide/start/concepts/)            |
| Conserver un environnement entre plusieurs tâches        | [Sandboxes réutilisables](../../../../guide/environment/lifecycle/) |
| Coordonner des tâches et des agents                      | [Premier workflow](../../../../guide/workflows/graph/)              |
| Retrouver une option ou un type de retour                | [Index de l’API](../../../)                                         |
| Diagnostiquer un échec                                   | [Dépannage](../../../../guide/operations/troubleshooting/)          |
...
Explorez les [cookbooks](../../../../guide/cookbook/) pour des recettes complètes, du correctif ciblé au workflow de livraison validé.
