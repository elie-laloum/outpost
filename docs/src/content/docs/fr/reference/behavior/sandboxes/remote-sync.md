...
[Daytona](../../../../guide/environment/providers/daytona/) prend en charge un terminal PTY natif depuis la version 4.0.0. Vercel refuse l’attachement interactif. Voir [les commandes et sessions terminal](../../../../guide/environment/commands/) pour les flux et l’annulation.
