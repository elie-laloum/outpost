...
| ---------------- | ------------------------------------- | --------- | --------------------------------------------------------------------------------------------------------------------------- |
| `source`         | `"transport" \| undefined`            | Optionnel | Vaut transport pour un plan de stockage objet ; son application exige alors le même transport configuré, fourni séparément. |
