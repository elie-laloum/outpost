...
Utilisez un transfert conservé ayant passé la [vérification](../recovery-verification/) et un dépôt de destination explicite. La restauration modifie les fichiers et l’état Git ; commencez avec le dépôt jetable de l’[exemple de récupération](../recovery/).
