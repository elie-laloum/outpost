---
title: "Inspecter l’environnement réellement possédé"
description: "Lancez les diagnostics dans une sandbox sans requête à un agent."
---

Lancez les diagnostics dans une sandbox sans requête à un agent.
