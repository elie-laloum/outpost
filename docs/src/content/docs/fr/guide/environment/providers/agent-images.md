...
Utilisez un checkout des sources, Docker, un digest d’image de base vérifié et un snapshot Debian. Construire et signer une image dépasse une minute ; les commandes ci-dessous distinguent construction locale et publication vérifiée.
