---
title: "Préparer les outils avant le démarrage de l’agent"
description: "Installez les dépendances du projet une fois lorsque la sandbox devient prête."
---

Installez les dépendances du projet une fois lorsque la sandbox devient prête.
...
await using sandbox = await createSandbox({
  ...runtime,
  branch: { mode: "named", name: "workshop/hooks" },
  hooks: {
    ...runtime.hooks,
    sandboxReady: [
      ...(runtime.hooks.sandboxReady ?? []),
      { executable: "npm", arguments: ["ci"], deadlineMs: 120_000 },
    ],
  },
});
