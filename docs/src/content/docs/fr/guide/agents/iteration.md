---
title: "Borner une tâche itérative"
description: "Donnez à un agent au plus deux passes pour corriger le même petit défaut."
---

Donnez à un agent au plus deux passes pour corriger le même petit défaut.
...
const result = await dispatch({
  ...runtime,
  branch: { mode: "named", name: "workshop/passes" },
  brief: {
...
console.log({ completed: result.completed, passes: result.turns.length });
```
