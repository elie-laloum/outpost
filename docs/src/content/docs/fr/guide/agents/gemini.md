---
title: "Lancer une nouvelle session Gemini"
description: "Utilisez l’adapter Gemini pour une analyse bornée du projet de texte."
---

Utilisez l’adapter Gemini pour une analyse bornée du projet de texte.
