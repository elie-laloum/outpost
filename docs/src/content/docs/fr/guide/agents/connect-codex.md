---
title: "Connecter Codex explicitement"
description: "Choisissez une méthode de connexion Codex, puis vérifiez-la par une petite requête réelle."
---

Choisissez une méthode de connexion Codex, puis vérifiez-la par une petite requête réelle.
...
if (runtime.agent.name !== "codex")
  throw new Error("Select codex in workflow/.env");
