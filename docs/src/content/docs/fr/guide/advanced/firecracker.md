...
Ce provider expérimental nécessite un hôte Linux jetable avec KVM, un noyau et un système de fichiers préparés, ainsi qu’une connexion explicite à l’invité. Préparez les ressources ci-dessous avant l’exemple ; aucun provisionnement hôte n’est automatique.

<details>
<summary>Prérequis et procédure complète</summary>
