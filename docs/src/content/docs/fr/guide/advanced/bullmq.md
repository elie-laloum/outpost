...
Utiliser Node.js **24+**, npm et Docker. Aucun compte de modèle ni credential d’agent n’est nécessaire. Créer un répertoire de démonstration distinct et installer Outpost 5.0.0 ou ultérieur avec la dépendance BullMQ optionnelle :
