---
title: "Essayer un checkout de conteneur isolé"
description: "Utilisez le prototype de checkout privé plutôt que de monter les métadonnées Git hôtes."
---

Utilisez le prototype de checkout privé plutôt que de monter les métadonnées Git hôtes.
