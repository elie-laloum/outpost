...
| Conserver un environnement entre plusieurs tâches        | [Sandboxes réutilisables](../../../environment/lifecycle/) |
| Coordonner des tâches et des agents                      | [Premier workflow](../../../workflows/graph/)              |
| Retrouver une option ou un type de retour                | [Référence API](../../../../reference/diagnosesandbox/)    |
...
Explorez les [cookbooks](../../../cookbook/) pour des recettes complètes, du correctif ciblé au workflow de livraison validé.
