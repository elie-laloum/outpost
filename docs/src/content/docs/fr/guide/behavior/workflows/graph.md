...
Poursuivez avec [les politiques d’exécution](../../../workflows/execution/) ou [les tâches de sandbox](../../../workflows/sandbox-tasks/).

Consultez les [budgets de consommation](../../../workflows/budgets/) pour les limites partagées d’admission et de tokens, et la [télémétrie](../../../advanced/telemetry/) pour les métriques structurées.

Conservez les résultats après un redémarrage avec les [checkpoints de workflow](../../../advanced/checkpoints/).

Utilisez les [approbations et pauses](../../../advanced/approvals/) pour arrêter le workflow sur une décision persistante, les [artefacts typés](../../../advanced/artifacts/) pour échanger des données validées et les [workers distribués](../../../advanced/distributed/) pour une exécution en file. Les [candidats spéculatifs](../../../advanced/speculation/) constituent un prototype de recherche séparé sur activation explicite.
