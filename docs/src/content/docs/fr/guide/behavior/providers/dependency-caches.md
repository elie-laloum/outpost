...
Utilisez les commandes `podman volume` équivalentes pour Podman. Inspectez et supprimez les volumes individuellement, sans nettoyer les ressources étrangères. Les [images d'agents préconstruites](../../../environment/providers/agent-images/) réduisent aussi le temps de préparation.
