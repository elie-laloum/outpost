...
Lisez [la synchronisation distante](../../../environment/remote-sync/) avant d’activer `includeUncommitted` ou de modifier simultanément le workspace hôte. Les tests de contrat n’allouent pas de sandbox payante réelle.
