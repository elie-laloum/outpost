...
Un processus ou hook en échec fait échouer le dispatch. Le travail non commité est conservé pour la [récupération](../../../cookbook/recovery/). Réutiliser la branche reprend son historique ; choisissez un autre nom pour une tentative indépendante.
