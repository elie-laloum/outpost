...
Consultez les [contrôles de structure, empreintes et restauration Git](../../../operations/recovery-verification/).

## Vérifier les empreintes enregistrées du transfert

Les [manifestes SHA-256](../../../operations/recovery-verification/) sont vérifiés explicitement, séparément de l’applicabilité des patches.
...
Consultez aussi la [rétention et les quotas](../../../operations/storage-retention/) pour planifier un nettoyage explicite.
