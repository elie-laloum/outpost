...
Après [l’inventaire des données de récupération](../../../operations/recovery/) et [la vérification du transfert conservé](../../../operations/recovery-verification/), choisissez l’état à reconstruire. La restauration crée un checkout Git indépendant dans un nouveau dossier extérieur au dépôt source, aux métadonnées Git et au transfert. Son dossier parent doit déjà exister. Toute destination existante, même vide ou symbolique, est refusée.
