...
| ------------- | ------------------------------------------------ | ----------------------------------------------- |
| Léger         | [Correctif ciblé](./focused-fix/)                | Une petite modification sur une branche séparée |
| Léger         | [Rapport typé](./typed-report/)                  | Des données validées pour un autre programme    |
