...
Utilisez cette recette pour des tâches indépendantes des modifications des autres. Chacune reçoit sa branche, son worktree et sa sandbox. Préparez l’[installation commune](../) ; vérifiez que machine et compte supportent deux agents simultanés.
