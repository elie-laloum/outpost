...
La commande de test fournit un véritable code de sortie. La revue est consultative ; rien n’est fusionné automatiquement. Inspectez la branche ou utilisez les [contrôles de livraison](../delivery-gate/). La sandbox se ferme à la sortie du bloc, même si un test échoue.
