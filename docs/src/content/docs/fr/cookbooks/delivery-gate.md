...
Cette recette autorise explicitement l’intégration dans la branche hôte après validation. Partez d’une branche attachée et propre avec l’[installation commune](../). Adaptez les tests au projet.
