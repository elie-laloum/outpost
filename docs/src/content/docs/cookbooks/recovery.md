...
Use this when partial work matters. Complete the [shared setup](../) and Claude authentication. Cleanup and transcript collection can continue beyond the request timeout.
