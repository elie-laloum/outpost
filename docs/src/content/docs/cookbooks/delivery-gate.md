...
This recipe explicitly permits integration into the host branch after validation. Start from a clean attached branch with the [shared setup](../). Adapt tests to your actual project.
