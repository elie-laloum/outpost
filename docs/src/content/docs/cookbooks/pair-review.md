...
The test command supplies a real exit status. The review is advisory; nothing merges automatically. Inspect the named branch or use the [delivery gate](../delivery-gate/). Scope exit closes the sandbox even when a test fails.
