---
title: "Fix a regression on its own branch"
description: "Repair the workshop whitespace regression, keep its commits separate, and review before merging."
---

Repair the workshop whitespace regression, keep its commits separate, and review before merging.
...
[Contracts, options and edge cases](../../../reference/behavior/cookbooks/focused-fix/).
