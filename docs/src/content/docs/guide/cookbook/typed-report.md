---
title: "Return a validated defect report"
description: "Ask an agent to inspect the workshop and turn its answer into data your program can use."
---

Ask an agent to inspect the workshop and turn its answer into data your program can use.
