---
title: "Investigate independently in parallel"
description: "Inspect whitespace and Unicode handling using separate workspaces and sandboxes."
---

Inspect whitespace and Unicode handling using separate workspaces and sandboxes.
