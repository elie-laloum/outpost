---
title: "Connect an agent to a test gate"
description: "Run an implementation task, then require the real test command to succeed."
---

Run an implementation task, then require the real test command to succeed.
