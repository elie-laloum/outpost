---
title: "Declare only the environment you need"
description: "Read the selected configuration without printing credential values."
---

Read the selected configuration without printing credential values.
