---
title: "Connect Claude explicitly"
description: "Choose one Claude authentication method, then verify it with a small real request."
---

Choose one Claude authentication method, then verify it with a small real request.
