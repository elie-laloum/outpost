---
title: "Cancel work and reuse the sandbox"
description: "Cancel a long command, then prove the same sandbox still accepts work. No model call is needed."
---

Cancel a long command, then prove the same sandbox still accepts work. No model call is needed.
