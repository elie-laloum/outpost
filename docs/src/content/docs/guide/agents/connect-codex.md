---
title: "Connect Codex explicitly"
description: "Choose one Codex authentication method, then verify it with a small real request."
---

Choose one Codex authentication method, then verify it with a small real request.
