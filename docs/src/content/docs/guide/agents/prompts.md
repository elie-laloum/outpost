...
description: "Keep the objective separate from your script and insert current Git context into the brief."
---

Keep the objective separate from your script and insert current Git context into the brief.
