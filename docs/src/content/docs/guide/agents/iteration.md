---
title: "Bound an iterative task"
description: "Give an agent up to two passes to fix the same small defect."
---

Give an agent up to two passes to fix the same small defect.
