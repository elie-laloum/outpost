---
title: "Give an agent one task"
description: "Fix a failing test in an isolated branch and inspect what the agent actually produced."
---

Fix a failing test in an isolated branch and inspect what the agent actually produced.
