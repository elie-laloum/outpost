---
title: "Keep workflows outside the target repository"
description: "Select the Git repository explicitly even when your script lives elsewhere."
---

Select the Git repository explicitly even when your script lives elsewhere.
