...
description: "Run the workshop test suite and observe the intentionally failing regression."
---

Run the workshop test suite and observe the intentionally failing regression.
