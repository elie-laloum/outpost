---
title: "Separate Git work from environment lifetime"
description: "Run two environments successively against the same owned branch."
---

Run two environments successively against the same owned branch.
