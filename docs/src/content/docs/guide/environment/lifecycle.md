---
title: "Keep an environment running"
description: "Create a temporary file, then read it in a second command in the same sandbox."
---

Create a temporary file, then read it in a second command in the same sandbox.
