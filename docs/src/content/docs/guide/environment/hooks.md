---
title: "Prepare tools before an agent starts"
description: "Install the workshop dependencies once when the sandbox becomes ready."
---

Install the workshop dependencies once when the sandbox becomes ready.
