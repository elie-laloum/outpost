---
title: "Choose Docker or Podman"
description: "Run the same Git command through either container engine."
---

Run the same Git command through either container engine.
