---
title: "Understand remote transfer before changing files"
description: "Verify that binary data reaches the running filesystem and that temporary probe files are cleaned."
---

Verify that binary data reaches the running filesystem and that temporary probe files are cleaned.
...
[Contracts, options and edge cases](../../../reference/behavior/sandboxes/remote-sync/).
