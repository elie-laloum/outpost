---
title: "Choose where changes go"
description: "Create a named branch without moving or merging the host branch."
---

Create a named branch without moving or merging the host branch.
