...
An adapter can be composed as `{ ...claude(), storage: transportConversations("claude", { transporter, namespace: "project-a" }) }`. Native authentication remains independent of transcript storage.
