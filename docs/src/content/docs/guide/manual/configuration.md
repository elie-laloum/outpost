...
Start with [an executable setup](../../start/quickstart/). Detailed rules: [environment and authentication](../../behavior/agents/environment/), [repository paths](../../behavior/sandboxes/repositories/), [CLI options](../cli/).
