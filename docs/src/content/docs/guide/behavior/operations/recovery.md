...
See [structure, checksum and isolated Git restoration checks](../../../operations/recovery-verification/).

## Check recorded transfer checksums

[SHA-256 manifests](../../../operations/recovery-verification/) are checked explicitly, separately from patch applicability.
...
See [retention and quotas](../../../operations/storage-retention/) to plan explicit cleanup.
