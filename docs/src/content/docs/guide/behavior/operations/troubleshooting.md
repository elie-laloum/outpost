...
Use [host diagnostics](../../../operations/doctor/) to check prerequisites before investigating an execution failure.
...
For reports, include OS, Node/Outpost/provider/agent versions, sanitized error code and the smallest reproducible configuration. Strip credentials, private prompts and source from shared logs. See [recovery](../../../operations/recovery/) for retained data and [security](../../../operations/security/) for private reporting.
