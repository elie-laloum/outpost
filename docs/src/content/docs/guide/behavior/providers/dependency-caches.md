...
Use the equivalent `podman volume` commands for Podman. Inspect and remove individual volumes; do not prune unrelated engine resources. See [prebuilt agent images](../../../environment/providers/agent-images/) to reduce image setup time too.
