...
[Daytona](../../../environment/providers/daytona/) supports native PTY attachment on current main. Vercel rejects interactive attachment. See [commands and terminal sessions](../../../environment/commands/) for streaming and cancellation behavior.
