...
Continue with [execution policies](../../../workflows/execution/) or [sandbox tasks](../../../workflows/sandbox-tasks/).

See [usage budgets](../../../workflows/budgets/) for shared admission and token limits, and [telemetry](../../../advanced/telemetry/) for structured metrics.

Persist results across process restarts with [workflow checkpoints](../../../advanced/checkpoints/).

Use [approval and pause gates](../../../advanced/approvals/) to stop at persisted decisions, [typed artifacts](../../../advanced/artifacts/) to exchange validated data, and [distributed workers](../../../advanced/distributed/) for queued execution. [Speculative candidates](../../../advanced/speculation/) are a separate opt-in research helper.
