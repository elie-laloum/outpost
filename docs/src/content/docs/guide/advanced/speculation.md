---
title: "Compare validated candidate fixes"
description: "Race two bounded approaches to the same defect and select a candidate only after tests."
---

Race two bounded approaches to the same defect and select a candidate only after tests.
