---
title: "Run an offline container command"
description: "Try the opt-in deny-all egress prototype with an already built image."
---

Try the opt-in deny-all egress prototype with an already built image.
