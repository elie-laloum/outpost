---
title: "Wrap a provider through its contract"
description: "Add an allocation observation while delegating execution and cleanup to an existing backend."
---

Add an allocation observation while delegating execution and cleanup to an existing backend.
