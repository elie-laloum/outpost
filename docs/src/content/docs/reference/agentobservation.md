...
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `kind`       | `"phase" \| "summary" \| "warning" \| "text" \| "result" \| "prompt" \| "tool" \| "tool-result" \| "step" \| "conversation" \| "usage" \| "failure" \| "finished" \| "raw"` | Required          | Discriminator selecting the event payload: phase, summary, warning, text, result, prompt, tool, tool-result, step, conversation, usage, failure, finished or raw. |
...
| `callId`     | `string \| undefined \| string`                                                                                                                                             | Variant-dependent | Identifier linking a tool event to its tool-result event; set by custom harnesses.                                                                                |
