...
Public contract for **QueueHandlerContext**. See the [distributed execution guide](../../guide/advanced/distributed/) for behavior, defaults and examples.
...
| `job`    | `QueueJob`    | Required | See the linked contract and this family's rules for its interpretation. |
