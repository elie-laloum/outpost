...
| `options.transporter`  | `Transport \| undefined`            | Optional | Optional transport whose payload usage and shared reservation ledger replace local admission accounting. Reservations persist until explicit release and do not impose physical quotas. |
