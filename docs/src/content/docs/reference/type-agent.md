...
| `capture`               | `boolean \| undefined \| false`                                                        | Variant-dependent | Whether the adapter enables native transcript capture.                                                                                         |
| `resumable`             | `boolean \| undefined \| false`                                                        | Variant-dependent | Whether the adapter supports native conversation continuation.                                                                                 |
