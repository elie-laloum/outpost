...
Public contract for **claude**. See the [agents guide](../../guide/agents/adapters/) for behavior, defaults and examples.
...
| ---------- | ----------------------------- | -------- | ----------------------------------------------------------------------- |
| `settings` | `ClaudeSettings \| undefined` | Optional | See the linked contract and this family's rules for its interpretation. |
