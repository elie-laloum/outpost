...
| `options.telemetry`          | `DispatchTelemetry \| undefined`                                 | Optional | Optional instrumentation of the complete dispatch, including preparation, synchronization and cleanup; telemetry failures do not change its outcome.     |
