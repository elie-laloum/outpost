...
| `tool`         | `((event: { readonly kind: "tool"; readonly name: string; readonly input: unknown; } & { readonly pass: number; readonly at: string; }) => void \| Promise<void>) \| undefined`                                                                     | Optional | Handle the tool name and input reported by the agent; receives pass and at metadata and may return a promise.                                   |
