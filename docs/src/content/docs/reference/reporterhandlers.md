...
| `text-delta`     | `((event: { readonly kind: "text-delta"; readonly text: string; } & { readonly pass: number; readonly at: string; }) => void \| Promise<void>) \| undefined`                                                                                                             | Optional | Handle a streamed fragment of model text from a custom harness; receives pass and at metadata and may return a promise.                                  |
...
| `tool-denied`    | `((event: { readonly kind: "tool-denied"; readonly callId: string; readonly name: string; readonly reason: string; } & { readonly pass: number; readonly at: string; }) => void \| Promise<void>) \| undefined`                                                          | Optional | Handle a tool call denied by permissions or a hook, with its reason; receives pass and at metadata and may return a promise.                             |
| `stop-prevented` | `((event: { readonly kind: "stop-prevented"; readonly message: string; } & { readonly pass: number; readonly at: string; }) => void \| Promise<void>) \| undefined`                                                                                                      | Optional | Handle a final answer refused by a stop hook, with the message sent back; receives pass and at metadata and may return a promise.                        |
| `compaction`     | `((event: { readonly kind: "compaction"; readonly strategy: string; readonly messages: number; } & { readonly pass: number; readonly at: string; }) => void \| Promise<void>) \| undefined`                                                                              | Optional | Handle a custom harness history compaction, with the strategy name and message count; receives pass and at metadata and may return a promise.            |
