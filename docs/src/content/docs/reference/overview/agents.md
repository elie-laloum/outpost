...
For direct API calls without an agent CLI, see [experimental model providers](../model-providers/). Their first phase does not include the harness required to execute agent tools.
