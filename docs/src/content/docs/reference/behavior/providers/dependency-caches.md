...
Use the equivalent `podman volume` commands for Podman. Inspect and remove individual volumes; do not prune unrelated engine resources. See [prebuilt agent images](../../../../guide/environment/providers/agent-images/) to reduce image setup time too.

Cache volumes are outside the [repository storage quotas](../../../../guide/operations/storage-retention/).
