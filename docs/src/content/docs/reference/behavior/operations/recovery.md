...
See [structure, checksum and isolated Git restoration checks](../../../../guide/operations/recovery-verification/).

## Check recorded transfer checksums

[SHA-256 manifests](../../../../guide/operations/recovery-verification/) are checked explicitly, separately from patch applicability.
...
See [retention and quotas](../../../../guide/operations/storage-retention/) to plan explicit cleanup.
