...
See [mounts](../../../../guide/environment/providers/containers/) and [security boundaries](../../../../guide/operations/security/).

## Connect an account

Follow [Claude Code account setup](../../../../guide/agents/connect-claude/) or [Codex account setup](../../../../guide/agents/connect-codex/) for subscription login, API keys and container authentication. Merely declaring OPENAI_API_KEY does not initialize a Codex login; use the documented setup hook.
