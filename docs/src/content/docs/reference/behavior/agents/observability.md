...
Workflow usage budgets and privacy-preserving metrics are covered in [budgets](../../../../guide/workflows/budgets/) and [OpenTelemetry](../../../../guide/advanced/telemetry/).

See [retention policies and quotas](../../../../guide/operations/storage-retention/) for explicit pruning of closed journals.
