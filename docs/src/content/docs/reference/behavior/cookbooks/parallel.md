...
Use this for tasks that do not depend on each other’s edits. Each receives its own branch, worktree and sandbox. Complete the [shared setup](../../../../guide/cookbook/); ensure the machine and account support two concurrent agents.
