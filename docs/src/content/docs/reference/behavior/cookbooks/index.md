...
| ------------ | ------------------------------------------------------------------------ | ----------------------------------- |
| Light        | [Focused fix](../../../guide/cookbook/focused-fix/)                      | A small change on a separate branch |
| Light        | [Typed report](../../../guide/cookbook/typed-report/)                    | Validated data for another program  |
| Intermediate | [Codex implements, Claude reviews](../../../guide/cookbook/pair-review/) | Two agents sharing a workspace      |
| Intermediate | [Parallel investigations](../../../guide/cookbook/parallel/)             | Independent branches and results    |
| Advanced     | [Delivery gates](../../../guide/cookbook/delivery-gate/)                 | Tests and review before integration |
| Operations   | [Recovery](../../../guide/cookbook/recovery/)                            | Inspect and resume partial work     |

## Shared setup

Use Node.js 24+, a committed Git repository, Docker and the image built by [quick start](../../../guide/start/quickstart/). Choose the Podman provider explicitly if needed. Install project tools in that image. Configure [Claude](../../../guide/agents/connect-claude/) or [Codex](../../../guide/agents/connect-codex/) before running a recipe.
