...
Use this when a dashboard or another task needs structured data. Complete [Claude authentication](../../../../guide/agents/connect-claude/) and the [shared setup](../../../../guide/cookbook/).
...
One repair turn can resume with validation feedback. Exhausted repair throws a response error with recovery metadata. Keep structured responses at one pass. See [validated responses](../../../../guide/agents/responses/).
