...
Use this when partial work matters. Complete the [shared setup](../../../../guide/cookbook/) and Claude authentication. Cleanup and transcript collection can continue beyond the request timeout.
...
Keep the named branch's commits. Inspect retained worktrees before moving/deleting them. See [continuation](../../../../guide/agents/conversations/) and [recovery details](../../../../guide/operations/recovery/).
