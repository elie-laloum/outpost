...
This guide uses Codex and Docker. Choose a Git repository with a commit. The workflow will live in a separate directory; see also [installation](../../../../guide/start/installation/).
...
To control the lifecycle yourself, read [one-shot dispatch](../../../../guide/agents/dispatch/) and [branch policies](../../../../guide/environment/branches/). To automate several steps, continue with [workflows](../../../../guide/workflows/graph/).

For account-based access, follow [Connect Codex](../../../../guide/agents/connect-codex/) or [Connect Claude](../../../../guide/agents/connect-claude/). The CLI already includes the Codex API-key login hook in generated scripts; manual API compositions must configure it explicitly.
