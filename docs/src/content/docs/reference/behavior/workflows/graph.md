...
Continue with [execution policies](../../../../guide/workflows/execution/) or [sandbox tasks](../../../../guide/workflows/sandbox-tasks/).

See [usage budgets](../../../../guide/workflows/budgets/) for shared admission and token limits, and [telemetry](../../../../guide/advanced/telemetry/) for structured metrics.

Persist results across process restarts with [workflow checkpoints](../../../../guide/advanced/checkpoints/).

Use [approval and pause gates](../../../../guide/advanced/approvals/) to stop at persisted decisions, [typed artifacts](../../../../guide/advanced/artifacts/) to exchange validated data, and [distributed workers](../../../../guide/advanced/distributed/) for queued execution. [Speculative candidates](../../../../guide/advanced/speculation/) are a separate opt-in research helper.
