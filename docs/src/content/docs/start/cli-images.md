...
The generated image uses Node 24 and includes Git, GitHub CLI, Python and both supported agent CLIs. Selecting Beads adds its pinned CLI. Install additional project tools in the generated recipe, then rebuild.
