...
The generated image uses Node 24 and includes Git, Python and the Claude Code, Codex and Gemini CLIs. Install additional project tools in the generated recipe, then rebuild.
