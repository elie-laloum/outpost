...
For an integration workspace, call `sandbox.workspace.integrate()` explicitly when warm work should enter the host branch. Review and commit the intended changes first. The [workspace guide](../workspaces/) explains separate ownership.
